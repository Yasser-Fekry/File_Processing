...
insert into Test (user_id, First_Name, Last_Name) values
(1, 'Ahmed', 'Ali'),
(2, 'Sara', 'Ibrahim'),
(3, 'Mohamed', 'Hassan');

insert into Test2 (order_id, name, price, user_id) values
(101, 'Keyboard', 150.00, 1),
(102, 'Mouse', 75.50, 1),
(103, 'Monitor', 1200.00, 2),
(104, 'USB Cable', 25.00, 3);
